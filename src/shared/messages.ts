import type { Account, IndexState, LogEntry, Video } from "./types";
...
export type BackgroundResponse =
  | { type: "INDEX_STATE"; state: IndexState; activeAccountId: string | null }
  | { type: "VIDEOS"; videos: Video[]; state: IndexState }
